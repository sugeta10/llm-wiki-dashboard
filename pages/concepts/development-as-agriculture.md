...
- 2026-08-25: @shin_sasaki19 がAnthropic公開の『AI-Native SDLC Playbook』を紹介し、その答えを「コードは、もうボトルネックではない」——AIエージェントで実装が数時間まで縮むと別の問題が発生する——と要約（teaserで続き・原典は未捕捉。本ページの「生成は増やせても確認速度は増やせない」と同型の主張がAnthropic公式文書側からも出た形）
