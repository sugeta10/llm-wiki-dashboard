...
- [[concepts/gpt-6-astra-skills-prompting]] — OpenAI Codex チーム（Eric Provencher）が GPT-6 Astra 向けに語った同じ転換（手取り足取りの足場を外す・SKILL.md を薄いルーターに・AGENTS.md の各行を再審査）。本記事の「ルール→判断」「前もって全部→progressive disclosure」のベンダー違いの並行例
